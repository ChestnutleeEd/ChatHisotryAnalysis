...
function ScaleScene({ sections }: { readonly sections: readonly BetaLocalizedReportSectionV1[] }) {
  ...
  return (
    <Scene id="scale-scene" scene="scale" layoutMode="asymmetric" className="beta-v2-scene beta-v2-scale" reveal motionIndex={0} aria-labelledby="beta-v2-scene-scale-heading">
      <SceneHeading number="02" scene="scale" title="把这一年放到尺度里" summary="一个主数字先回答消息量，再用聊天日与连续区间补充活动范围。" />
      <div className="beta-v2-scale-grid">
        <LogicalSection section={messages} className="beta-v2-scale-hero" data-v3-geometry-cell="scale-primary" data-v3-cell-mode="asymmetric">
          <p className="beta-v2-dominance-note">主视线：消息总量</p>
        </LogicalSection>
        <div className="beta-v2-scale-support" data-v3-geometry-cell="scale-support" data-v3-cell-mode="asymmetric">
...
function RhythmScene({ sections }: { readonly sections: readonly BetaLocalizedReportSectionV1[] }) {
  ...
  return (
    <Scene id="rhythm-scene" scene="rhythm" layoutMode="full" className="beta-v2-scene beta-v2-rhythm" reveal motionIndex={1} aria-labelledby="beta-v2-scene-rhythm-heading">
      <SceneHeading number="03" scene="rhythm" title="节奏不是一条横条" summary="月份承担主叙事，星期与小时退到两个可读的分布带，峰值和完整数据都直接可查。" />
      <LogicalSection section={month} className="beta-v2-rhythm-month" data-v3-geometry-cell="rhythm-month" data-v3-cell-mode="full" />
      <div className="beta-v2-rhythm-strips" data-v3-geometry-cell="rhythm-strips" data-v3-cell-mode="paired">
...
function BalanceScene({ sections }: { readonly sections: readonly BetaLocalizedReportSectionV1[] }) {
  ...
  return (
    <Scene id="balance-scene" scene="balance" layoutMode="asymmetric" className="beta-v2-scene beta-v2-balance" reveal motionIndex={2} aria-labelledby="beta-v2-scene-balance-heading">
      ...
      <div className="beta-v2-balance-grid">
        <LogicalSection section={sender} className="beta-v2-balance-primary" data-v3-geometry-cell="balance-primary" data-v3-cell-mode="asymmetric" />
        <div className="beta-v2-balance-support" data-v3-geometry-cell="balance-support" data-v3-cell-mode="asymmetric">
...
function ConversationScene({ sections }: { readonly sections: readonly BetaLocalizedReportSectionV1[] }) {
  ...
  return (
    <Scene id="conversation-scene" scene="conversation" layoutMode="asymmetric" className="beta-v2-scene beta-v2-conversation" reveal motionIndex={3} aria-labelledby="beta-v2-scene-conversation-heading">
      ...
      <div className="beta-v2-conversation-grid">
        <LogicalSection section={sessions} className="beta-v2-conversation-primary" data-v3-geometry-cell="conversation-primary" data-v3-cell-mode="asymmetric" />
        <LogicalSection section={replies} className="beta-v2-conversation-secondary" data-v3-geometry-cell="conversation-secondary" data-v3-cell-mode="asymmetric" />
      </div>
    </Scene>
  );
}
