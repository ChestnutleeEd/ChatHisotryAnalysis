...
export const BETA_REPORT_SECTIONS: readonly BetaReportSectionDefinition[] = [
  ...
  section("messages", 2, "消息", "这一范围聊了多少？", "opening", "core"),
  section("active-days", 3, "聊天日", "有多少天聊过？", "activity", "core"),
  section("longest-streak", 4, "最长连续聊天", "最长连续聊了多久？", "activity", "core"),
  ...
  section("sender-share", 8, "发送方分布", "双方各发了多少？", "comparison", "core"),
  section("message-length", 9, "消息长度", "文字消息通常有多长？", "comparison", "core"),
  section("message-types", 10, "消息类型", "除了文字，还发了什么？", "comparison", "core"),
  section("sessions", 11, "会话", "一次聊天如何开始？", "activity", "core"),
  section("replies", 12, "回复间隔", "回复间隔通常多久？", "activity", "core"),
  section("frequent-words", 13, "常用词", "这一范围最常提到什么？", "language", "vocabulary"),
  section("distinctive-keywords", 14, "年度关键词", "哪些词更能代表这一年？", "language", "vocabulary"),
  section("word-cloud", 15, "词云", "这些词放在一起是什么样？", "language", "cloud"),
