...
pub fn record_selection_smoke_checkpoint(
    ...
    let filename = if checkpoint == "resolution" {
        ...
        match checkpoint.as_str() {
            ...
            "share-preview-trigger-missing" => "selection-smoke-share-preview-trigger-missing",
            "share-preview-trigger-disabled" => "selection-smoke-share-preview-trigger-disabled",
            "share-preview-trigger-enabled" => "selection-smoke-share-preview-trigger-enabled",
            "share-preview-dialog-open" => "selection-smoke-share-preview-dialog-open",
            "share-preview-dialog-not-ready" => "selection-smoke-share-preview-dialog-not-ready",
            "share-preview-vocabulary-missing" => "selection-smoke-share-preview-vocabulary-missing",
            "share-preview-vocabulary-unavailable" => "selection-smoke-share-preview-vocabulary-unavailable",
            "share-preview-vocabulary-disabled" => "selection-smoke-share-preview-vocabulary-disabled",
            "share-preview-vocabulary-enabled" => "selection-smoke-share-preview-vocabulary-enabled",
            "share-preview-vocabulary-clicked" => "selection-smoke-share-preview-vocabulary-clicked",
            "share-preview-vocabulary-not-ready" => "selection-smoke-share-preview-vocabulary-not-ready",
